...
class CaptchaDownloader:
    ...
    def download_from_url(self, url):
        """从URL下载验证码图片"""
        try:
            response = requests.post(url, data={"captchaType": "blockPuzzle"})
            ...
            original_save_path = os.path.join(settings.IMAGE_SAVE_PATH, "originalImage")
            jigsaw_save_path = os.path.join(settings.IMAGE_SAVE_PATH, "jigsawImage")
